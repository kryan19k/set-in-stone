  ...
  return (
    <>
      ...
      <motion.nav
        ...
        className="fixed top-0 left-0 right-0 z-50 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-gray-200 dark:border-slate-700/50"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <Link href="/" className="flex items-center space-x-3">
              ...
              <span className="text-xl font-cursive font-bold bg-gradient-to-r from-cyan-600 to-slate-800 dark:from-cyan-400 dark:to-slate-200 bg-clip-text text-transparent">
                Set in Stone
              </span>
            </Link>
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <div className="flex items-center space-x-4">
                <Button
                  variant="outline"
                  className="border-cyan-500/50 dark:border-cyan-400/50 text-cyan-600 dark:text-cyan-400 hover:bg-cyan-50 dark:hover:bg-cyan-400/10 hover:border-cyan-600 dark:hover:border-cyan-400"
                >
                  Submit Story
                </Button>
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="fixed top-16 left-0 right-0 z-40 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border-b border-gray-200 dark:border-slate-700/50 md:hidden"
          >
              ...
              {navItems.map((item, index) => (
                ...
                >
                  <Link
                    ...
                    className="block py-3 px-4 text-slate-600 dark:text-slate-300 hover:text-cyan-600 dark:hover:text-cyan-400 hover:bg-gray-50 dark:hover:bg-slate-800/50 rounded-lg transition-all duration-200 font-medium"
                  >
                    {item.name}
                  </Link>
                </motion.div>
